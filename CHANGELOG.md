...
- Removing a project is logged, and a removal the CLI refuses is reported instead of discarded. Every other action on the panel left a line; this one ran silently, and its result was never even read.
